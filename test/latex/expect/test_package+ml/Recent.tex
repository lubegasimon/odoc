...
\begin{ocamlindent}\end{ocamlindent}%
\end{ocamlindent}%
\label{container-page-test+u+package+++ml-module-Recent-type-polymorphic+u+variant}\ocamlcodefragment{\ocamltag{keyword}{type} polymorphic\_\allowbreak{}variant = [ }\begin{ocamlindent}\ocamlinlinecode{| }\ocamlinlinecode{`A}\label{container-page-test+u+package+++ml-module-Recent-type-polymorphic+u+variant.A}%
\begin{ocamlindent}\end{ocamlindent}%
...
\begin{ocamlindent}\end{ocamlindent}%
\ocamlinlinecode{| }\ocamlinlinecode{`C}\label{container-page-test+u+package+++ml-module-Recent-type-polymorphic+u+variant.C}%
\begin{ocamlindent}\begin{flushleft}\end{flushleft}%
foo\end{ocamlindent}%
\ocamlinlinecode{| }\ocamlinlinecode{`D}\label{container-page-test+u+package+++ml-module-Recent-type-polymorphic+u+variant.D}%
\begin{ocamlindent}\begin{flushleft}\end{flushleft}%
bar\end{ocamlindent}%
\end{ocamlindent}%
\ocamlcodefragment{ ]}\\
